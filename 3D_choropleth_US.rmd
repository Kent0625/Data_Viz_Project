...
# Diabetes Epidemiological Risk Palette:
# Clinical blood-glucose & public health alert scale:
# Sequential gradient: pale warm rose (low prevalence) -> vivid blood red -> deep crimson maroon (peak epidemic clusters)
...
diabetes_map <- ggplot(merged_data) +
  ...
  scale_fill_gradientn(colors = diabetes_colors,
                       name = "Diabetes (%)",
                       na.value = "grey80") +
  theme_minimal() +
  labs(title = "Diabetes Distribution in the U.S.: A County-Level Analysis",
       caption = "Source: CDC Diabetes Atlas | Visualization by Kent John Macalam") +
